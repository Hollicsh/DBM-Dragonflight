...
mod:AddSetIconOption("SetIconOnMages", -25144, true, 5, {6, 5, 4})
mod:AddSetIconOption("SetIconOnStormbringers", -25139, true, 5, {8, 7})

mod:GroupSpells(385618, -25144, -25139)--Icon Marking with general adds announce
