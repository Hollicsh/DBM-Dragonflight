...
local specWarnRockBlast							= mod:NewSpecialWarningYou(380487, nil, nil, nil, 1, 2, nil, nil, "targetyou")
...
local specWarnBrutalReverberation				= mod:NewSpecialWarningDodge(386400, nil, nil, nil, 2, 2, nil, nil, "watchstep")
...
local specWarnFrenziedDevastation				= mod:NewSpecialWarningSpell(377505, nil, nil, nil, 3, 2, nil, nil, "stilldanger")
local specWarnInfusedFallout					= mod:NewSpecialWarningYou(391592, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnGTFO								= mod:NewSpecialWarningGTFO(382458, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
