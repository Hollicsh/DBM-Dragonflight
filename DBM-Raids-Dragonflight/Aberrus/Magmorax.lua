...
DBM:RegisterAltSpellName(402994, 307031)--Molten Spittle -> Lava Pools
DBM:RegisterAltSpellName(403740, 188832)--Igniting Roar -> Roar
...
local specWarnHeatStacks							= mod:NewSpecialWarningStack(408839, nil, 35, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnBlazingTantrum						= mod:NewSpecialWarningMove(407879, "Tank", nil, nil, 1, 2, nil, nil, "moveboss")
local specWarnIgnitingRoar							= mod:NewSpecialWarningCount(403740, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnOverpoweringStomp						= mod:NewSpecialWarningCount(403671, nil, nil, nil, 2, 2, nil, nil, "carefly")
local specWarnMoltenSpittle							= mod:NewSpecialWarningYou(402994, nil, nil, nil, 1, 2, nil, nil, "gathershare")
...
local specWarnBlazingBreath							= mod:NewSpecialWarningDodgeCount(409093, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
local specWarnIncineratingMaws						= mod:NewSpecialWarningStack(404846, nil, 2, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnIncineratingMawsSwap					= mod:NewSpecialWarningTaunt(404846, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnGTFO									= mod:NewSpecialWarningGTFO(411633, nil, nil, nil, 1, 8, nil, nil, "watchfeet")

local timerCatastrophicCD							= mod:NewCDTimer(28.9, 408358, nil, nil, nil, 2, nil, DBM_COMMON_L.DEADLY_ICON)
local timerMoltenSpittleCD							= mod:NewCDCountTimer(29.9, 402994, nil, nil, nil, 3)--"Lava Pools"
local timerIngitingRoarCD							= mod:NewCDCountTimer(28.9, 403740, nil, nil, nil, 2, nil, DBM_COMMON_L.HEALER_ICON)--"Roar"
local timerOverpoweringStompCD						= mod:NewCDCountTimer(101.7, 403671, nil, nil, nil, 2)--"Knockback"
local timerBlazingBreathCD							= mod:NewCDCountTimer(29.9, 409093, nil, nil, nil, 3)
