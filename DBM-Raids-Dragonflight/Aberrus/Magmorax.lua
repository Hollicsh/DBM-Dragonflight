...
local specWarnIgnitingRoar							= mod:NewSpecialWarningCount(403740, nil, 188832, nil, 2, 2, nil, nil, "aesoon")
local specWarnOverpoweringStomp						= mod:NewSpecialWarningCount(403671, nil, 149213, nil, 2, 2, nil, nil, "carefly")
local specWarnMoltenSpittle							= mod:NewSpecialWarningYou(402994, nil, 80801, nil, 1, 2, nil, nil, "gathershare")
...
local specWarnBlazingBreath							= mod:NewSpecialWarningDodgeCount(409093, nil, 18357, nil, 2, 2, nil, nil, "breathsoon")
