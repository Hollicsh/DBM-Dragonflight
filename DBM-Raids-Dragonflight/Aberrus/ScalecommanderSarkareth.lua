...
--]]
DBM:RegisterAltSpellName(401500, 167180)--Scorching Bomb
DBM:RegisterAltSpellName(401680, 405391)--Mass Disintegrate -> Disintegrate
DBM:RegisterAltSpellName(402050, 18357)--Searing Breath -> Breath
DBM:RegisterAltSpellName(404027, 167180)--Void Bomb -> Bombs
DBM:RegisterAltSpellName(404456, 18357)--Abyssal Breath
DBM:RegisterAltSpellName(411302, 31295)--Cosmic Volley
DBM:RegisterAltSpellName(404754, 31295)--Blasting Scream
DBM:RegisterAltSpellName(403741, 161862)--Cosmic Ascension
DBM:RegisterAltSpellName(403510, 370470)--Astral Formation -> Pillar
DBM:RegisterAltSpellName(403625, 123244)--Scouring Eternity -> Hide
DBM:RegisterAltSpellName(403520, 229042)--Embrace of Nothingness -> Black Hole
DBM:RegisterAltSpellName(404269, 299144)--Ebon Might -> Immune
--General
...
local warnMassDisintegrate						= mod:NewTargetCountAnnounce(401680, 3, nil, nil, nil, nil, nil, nil, true)
...
local specWarnScorchingBomb						= mod:NewSpecialWarningCount(401500, nil, nil, nil, 2, 2, nil, nil, "bombsoon")

local specWarnMassDisintegrateYou				= mod:NewSpecialWarningYou(401680, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellMassDisintegrate						= mod:NewShortPosYell(401680, 405391)
local yellMassDisintegrateFades					= mod:NewIconFadesYell(401680)
local specWarnSearingBreath						= mod:NewSpecialWarningCount(402050, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
...
local timerMassDisintegrateCD					= mod:NewCDCountTimer(29.9, 401680, nil, nil, nil, 3)--"Disintegrate"
local timerSearingBreathCD						= mod:NewCDCountTimer(29.9, 402050, nil, nil, nil, 3, nil, DBM_COMMON_L.MAGIC_ICON)--"Breath"
...
local specWarnVoidBomb							= mod:NewSpecialWarningCount(404027, nil, nil, nil, 2, 2, nil, nil, "bombsoon")
...
local specWarnAbyssalBreath						= mod:NewSpecialWarningCount(404456, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
local specWarnEmptyStrike						= mod:NewSpecialWarningDefensive(404769, nil, nil, nil, 1, 2, 4, nil, "defensive")
local specWarnCosmicVolley						= mod:NewSpecialWarningInterruptCount(411302, "HasInterrupt", nil, nil, 1, 2, 4, nil, "kickcast")
...
local timerVoidBombCD							= mod:NewCDCountTimer(29.9, 404027, nil, nil, nil, 3)--"Bombs"
local timerAbyssalBreathCD						= mod:NewCDCountTimer(29.9, 404456, nil, nil, nil, 1)
...
local timerBlastingScreamCD						= mod:NewCDTimer(7.3, 404754, nil, false, 2, 4, nil, DBM_COMMON_L.INTERRUPT_ICON)--Spammy so off by default
...
local timerEbonMight							= mod:NewCastCountTimer("d29.9", 404269, nil, nil, nil, 5, nil, DBM_COMMON_L.DAMAGE_ICON)--"Immune"
...
local specWarnCosmicAscension					= mod:NewSpecialWarningDodgeCount(403741, nil, nil, nil, 2, 2, nil, nil, "watchstep")
...
local specWarnScouringEternity					= mod:NewSpecialWarningDodgeCount(403625, nil, nil, nil, 3, 2, nil, nil, "watchstep")
local specWarnEmbraceofNothingness				= mod:NewSpecialWarningYou(403520, nil, nil, nil, 1, 2, nil, nil, "gathershare")
...
local timerCosmicAscensionCD					= mod:NewCDCountTimer(29.9, 403741, nil, nil, nil, 1)
local timerAstralFormation						= mod:NewCDCountTimer(29.9, 403510, nil, nil, nil, 5)--Shorttext Pillar
local timerHurtlingBarrageCD					= mod:NewCDCountTimer(29.9, 405486, nil, nil, nil, 3)
local timerScouringEternityCD					= mod:NewCDCountTimer(29.9, 403625, nil, nil, nil, 3, nil, DBM_COMMON_L.DEADLY_ICON)--Shortname "Hide"
local timerEmbraceofNothingnessCD				= mod:NewCDCountTimer(29.9, 403520, nil, nil, nil, 3)--"Black Hole"
