...
--]]
DBM:RegisterAltSpellName(400430, 18357)--Hellbeam -> Breath
local warnDreadRifts								= mod:NewTargetCountAnnounce(407196, 3)
local warnDreadRayofAnguish							= mod:NewTargetCountAnnounce(407069, 4)

local specWarnHellsteelCarnage						= mod:NewSpecialWarningDodgeCount(401319, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnDreadRift								= mod:NewSpecialWarningYou(407196, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellDreadRift									= mod:NewShortPosYell(407196)
local yellDreadRiftFades							= mod:NewIconFadesYell(407196)
local specWarnRayofAnguish							= mod:NewSpecialWarningYou(402253, nil, nil, nil, 1, 2, nil, nil, "laserrun")
local yellRayofAnguish								= mod:NewShortYell(402253)
local specWarnHellbeam								= mod:NewSpecialWarningDodgeCount(400430, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnWindsofExtinction						= mod:NewSpecialWarningCount(403326, nil, nil, nil, 2, 13, nil, nil, "pushbackincoming")
local specWarnTerrorClaws							= mod:NewSpecialWarningDefensive(404743, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnTerrorClawsTaunt						= mod:NewSpecialWarningTaunt(404743, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnGTFO									= mod:NewSpecialWarningGTFO(406530, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
--
...
local timerHellbeamCD								= mod:NewCDCountTimer(35.5, 400430, nil, nil, nil, 3, nil, DBM_COMMON_L.DEADLY_ICON)--"Breath"
